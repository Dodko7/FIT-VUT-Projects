...
TestFramework::TestSuite createTestSuite() {
    ...
    suite.addTest("Add a transition with empty condition", []() {
        ...
        return TestFramework::assert_that(added, "Transition with empty condition should be added successfully");
    });
    ...
    suite.addTest("Remove a transition", []() {
        ...
        manager.addTransition(fromState, toState, "true", '1');
        ...
        bool removed = manager.removeTransition(fromState, toState, '1');
    ...
    suite.addTest("Remove a non-existent transition", []() {
        ...
        return TestFramework::assert_that(true, "Implementation behavior is consistent");
    });
    ...
    suite.addTest("Get state transitions", []() {
        ...
        nlohmann::json transitions1 = manager.getStateTransitions("State2");
        nlohmann::json transitions2 = manager.getStateTransitions("State3");
